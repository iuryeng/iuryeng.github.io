...
<title>TV, halftime shows, and the Big Game¶</title>
...
<body>
 ...
 <div class="container bg-white pt-100 pb-100">
    ...
    <div class="row ">
      ...
      <div class="col-md-12">
                  ...
                  <div class="block-title mb-30 ">
                    <h2 class="title">TV, halftime shows, and the Big Game</h2>
                  </div>
                  <hr class="mb-50">
                  </div>
                  ...
                  <div class="block-content ">
                    ...
                    <div class="block-nav-work mb-60">

                      <ul>
                      <li><a class="but brd white" href="#"><i class="icon-left-open-mini"></i></a></li>
                      <li><a class="but brd white" href="index.html"><i class="icon-cancel-1"></i></a></li>
                      <li><a class="but brd white" href="project-datacamp-proc-imagem-abelhas.html"><i class="icon-right-open-mini"></i></a></li>
                      </ul>
                    </div>
...
postgresql:///super_bowls            /* importa o banco de dados super_bowls*/
SELECT * from games                 /* seleciona a tabela games*/
ORDER BY date_game DESC LIMIT 5    /* ordenar por data os 5 primeiros dados em ordem decrescente*/
</pre></div>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="2.-Data-issues-in-the-broadcasts-table">2. Data issues in the broadcasts table<a class="anchor-link" href="#2.-Data-issues-in-the-broadcasts-table">&#182;</a></h2><p>For the Super Bowl game data, we can see the dataset appears whole except for missing values in the backup quarterback columns (<code>qb_winner_2</code> and <code>qb_loser_2</code>), which make sense given most starting QBs in the Super Bowl (<code>qb_winner_1</code> and <code>qb_loser_1</code>) play the entire game.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="o">%%</span><span class="k">sql</span>
SELECT * FROM broadcasts LIMIT 10        /* seleciona a tabela broadcasts e pega os 10 primeiros resultados*/
</pre></div>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="3.-Data-issues-in-the-performances-table">3. Data issues in the performances table<a class="anchor-link" href="#3.-Data-issues-in-the-performances-table">&#182;</a></h2><p>For the TV data, the following columns have missing values and a lot of them:</p>
<ul>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="o">%%</span><span class="k">sql</span>
SELECT * FROM performances     /* seleciona a tabela performaces */
WHERE num_songs IS NULL      /* seleciona a tabela performaces */
...
<table>
    ...
    <tr>
        <td>34</td>
        <td>17</td>
        <td>Los Angeles Unified School District All City Honor Marching Band</td>
        <td>None</td>
    </tr>
    <tr>
        <td>33</td>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="4.-The-highest--and-lowest-scoring-Super-Bowls">4. The highest- and lowest-scoring Super Bowls<a class="anchor-link" href="#4.-The-highest--and-lowest-scoring-Super-Bowls">&#182;</a></h2><p>We have missing numbers of songs performed (<code>num_songs</code>) for about a third of the performances, most of them for earlier Super Bowls.</p>
...
<div class=" highlight hl-ipython3"><pre><span></span><span class="o">%%</span><span class="k">sql</span>
SELECT * FROM games                                  /* seleciona a tabela games */
WHERE (combined_pts &gt; 70 OR combined_pts &lt; 25)      /*olha as combinação de pontos é &gt; 70 ou &lt; 25 */
</pre></div>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="5.-The-blowouts-and-nailbiters">5. The blowouts and nailbiters<a class="anchor-link" href="#5.-The-blowouts-and-nailbiters">&#182;</a></h2><p>The highest combined scores at 74 and 75, we find two games featuring dominant quarterback performances. One even happened recently in 2018's Super Bowl LII where Tom Brady's Patriots lost to Nick Foles' underdog Eagles 41-33 for a combined score of 74.</p>
...
<div class=" highlight hl-ipython3"><pre><span></span><span class="o">%%</span><span class="k">sql</span>
SELECT * FROM games                                    /* seleciona a tabela games */
WHERE (difference_pts =1 or difference_pts &gt;= 35)     /*olha pras diferenças de pontos igual 1 ou maior ou igual a 35 */
</pre></div>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="6.-Do-blowouts-translate-to-lost-viewers?">6. Do blowouts translate to lost viewers?<a class="anchor-link" href="#6.-Do-blowouts-translate-to-lost-viewers?">&#182;</a></h2><p>The closest game ever was when the Buffalo Bills lost to the New York Giants by 1 point in 1991, which was  best remembered for Scott Norwood's last-second missed field goal attempt that went <em><a href="https://www.youtube.com/watch?v=RPFZCGgjDSg">wide right</a></em>, kicking off four Bills Super Bowl losses in a row. Poor Scott. The biggest point discrepancy ever was 45 points (!) where Hall of Famer Joe Montana's led the San Francisco 49ers to victory in 1990, one year before the closest game ever.</p>
...
<table>
    <tr>
        <th>blowout</th>
        <th>avg_difference_pts</th>
        <th>avg_share_household</th>
    </tr>
    <tr>
        <td>False</td>
        <td>9.3250000000000000</td>
        <td>67.8250000000000000</td>
    </tr>
    <tr>
        <td>True</td>
        <td>29.3846153846153846</td>
        <td>61.9230769230769231</td>
    </tr>
</table>
</div>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="7.-Viewership-and-the-ad-industry-over-time">7. Viewership and the ad industry over time<a class="anchor-link" href="#7.-Viewership-and-the-ad-industry-over-time">&#182;</a></h2><p>We see a 6-point difference in average household share for blowouts vs. non-blowouts! Though it matches our intuition, we must take it with a grain of salt due to our small sample size of 52 games.</p>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="8.-Halftime-shows-weren't-always-this-great">8. Halftime shows weren't always this great<a class="anchor-link" href="#8.-Halftime-shows-weren't-always-this-great">&#182;</a></h2><p>We can see viewers increased before ad costs did. <code>avg_us_viewers</code> was 90 million in 1998 (Super Bowl XXXII) and an ad cost \$1.29 million. That is an <a href="https://westegg.com/inflation/">inflation-adjusted</a> \$2.02 million in 2018, where <code>avg_us_viewers</code> was actually 103 million and <code>ad_cost</code> was \$5 million. Maybe the networks weren't very data savvy and were slow to react. (It'd make sense since DataCamp didn't exist back then!)</p>
...
<table>
    ...
    <tr>
        <td>35</td>
        <td>18</td>
        <td>The University of Florida Fightin&#x27; Gator Marching Band</td>
        <td>7</td>
    </tr>
    <tr>
        <td>36</td>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="9.-Who-has-the-most-halftime-show-appearances?">9. Who has the most halftime show appearances?<a class="anchor-link" href="#9.-Who-has-the-most-halftime-show-appearances?">&#182;</a></h2><p>Lots of marching bands. American jazz clarinetist Pete Fountain. Miss Texas 1973 playing a violin. Nothing against those performers, they're just simply not <a href="https://www.youtube.com/watch?v=suIg9kTGBVI">Beyoncé</a>. To be fair, no one is.</p>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="10.-Who-performed-the-most-songs-in-a-halftime-show?">10. Who performed the most songs in a halftime show?<a class="anchor-link" href="#10.-Who-performed-the-most-songs-in-a-halftime-show?">&#182;</a></h2><p>The world famous <a href="https://www.youtube.com/watch?v=RL_3oqpHiDg">Grambling State University Tiger Marching Band</a> takes the crown with six appearances. Beyoncé, Justin Timberlake, Nelly, and Bruno Mars are the only post-Y2K musicians with multiple appearances (two each).</p>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="11.-Conclusion">11. Conclusion<a class="anchor-link" href="#11.-Conclusion">&#182;</a></h2><p>So most non-band musicians do 1-3 songs per halftime show. It's important to note that the duration of the halftime show is fixed (roughly 12 minutes) so songs per performance is more a measure of how many hit songs you have. JT went off in 2018, wow. 11 songs! Diana Ross comes in second with 10 in her medley in 1996.</p>
...
SELECT *
FROM games
WHERE (team_winner LIKE &#39;%Patriots%&#39; OR team_winner LIKE &#39;%Rams%&#39;)
AND (team_loser LIKE &#39;%Patriots%&#39; OR team_loser LIKE &#39;%Rams%&#39;);
</pre></div>
